...
class ScrapeWhatHappenedWhenTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function podcast_can_be_scraped()
    {
        Http::fake(
            CreateMegaphoneResponse::init()
                ->setUrl('https://player.megaphone.fm/playlist/WWO2089228444')
                ->addEpisode()
                ->generate()
        );
        ...
        $this->assertEquals('What Happened When', $episode->program);
